...
public class Main_Menu_Trendy extends BaseTest{
	...
	@Test(priority = 1)
	public void verifyLoggedinUserTrendyOption() throws InterruptedException {
		myAccountScreen.clickOnMyAccount();
		login.ExistinguserLogin("prathamesh@testriq.com", "Prathamesh*141#");
		mainMenu.verifytrendyOption();
		login.logoutFromPage();
	}
	
	@Test(priority = 2)
	public void verifyGuestUserTrendyOption() throws InterruptedException {
		mainMenu.verifytrendyOption();
	}
