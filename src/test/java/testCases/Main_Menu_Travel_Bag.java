...
public class Main_Menu_Travel_Bag extends BaseTest {
	...
	public void verifyAlltravelBagOption() throws InterruptedException {
		...
		mainMenu.verifyAlltravelBagOption();
		login.logoutFromPage();
	}

	@Test(priority = 2)
	public void guestverifyAlltravelBagOption() throws InterruptedException {
		mainMenu.verifyAlltravelBagOption();
	}
	...
	public void verifybagsOption() throws InterruptedException {
		myAccountScreen.clickOnMyAccount();
		login.ExistinguserLogin("prathamesh@testriq.com", "Prathamesh*141#");
		mainMenu.verifybagsOption();
		login.logoutFromPage();
	}

	@Test(priority = 4)
	public void guestverifybagsOption() throws InterruptedException {
		mainMenu.verifybagsOption();
	}
