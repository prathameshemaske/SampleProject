...
public class Main_Menu_Accessories extends BaseTest{
	...
	@Test(priority = 1)
	public void verifyLoggedinUserAccessoriesOption() throws InterruptedException {
		myAccountScreen.clickOnMyAccount();
		login.ExistinguserLogin("prathamesh@testriq.com", "Prathamesh*141#");
		mainMenu.verifyAccessoriesOption();
		login.logoutFromPage();
	}
	
	@Test(priority = 2)
	public void verifyGuestUserAccessoriesOption() throws InterruptedException {
		mainMenu.verifyAccessoriesOption();
	}
